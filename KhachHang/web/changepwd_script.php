<?php
    ...
    //echo $email;
    $password_from_database_query="select MatKhau from khachhang where Email='$email'";
    ...
    if($row['MatKhau']==$old_password){
        if($retype_Password != $new_password){
            ...
            $update_password_query="update khachhang set MatKhau='$new_password' where Email='$email'";
