...
(1, 'Giày thể thao trẻ em'),
(2, 'Giày thể thao nam'),
(3, 'Giày thể thao nữ'),
(4, 'Giày Bóng Rổ Trẻ Em'),
(5, 'Giày Adidas cao cấp'),
(6, 'Giày Nike cao cấp'),
(7, 'Giày Balenciaga'),
(8, 'New Balance'),
(10, 'Giày Puma');
...
CREATE TABLE `slide` (
  ...
  `Hinh` varchar(100) DEFAULT NULL,
  `LienKet` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
